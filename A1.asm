...
; prathamesh@prathamesh-Inspiron-3576:~/Documents/git_MPL$ nasm -f elf64 A1.asm
; prathamesh@prathamesh-Inspiron-3576:~/Documents/git_MPL$ ld -o a1 A1.o
; prathamesh@prathamesh-Inspiron-3576:~/Documents/git_MPL$ ./a1
; Count of Positive numbers: 0000000000000004
; Count of Negative numbers: 0000000000000006
